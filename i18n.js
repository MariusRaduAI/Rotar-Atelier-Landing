...
(function () {
  var STRINGS = {
    en: {
      ...
      'gallery.title': 'See for yourself',
      ...
      'gallery.lead': 'A few things we make.',
      'g1.t': 'The shared table',
      'g1.p': 'Roasted tomatoes and peppers, hummus, marinated olives and focaccia. Colour, olive oil and herbs, made to be shared.',
      'g1.l1': 'Roasted tomatoes, garlic and rosemary',
      'g1.l2': 'Marinated olives with mint and lemon',
      'g1.l3': 'Hummus with pomegranate and pine nuts',
      'alt.g1': 'Overhead view of roasted tomatoes, marinated olives and a bowl of hummus with pomegranate',
      'g2.t': 'Rolled ham skewers',
      'g2.p': 'Finger food, finished with mint, pomegranate and lemon zest.',
      'alt.g2': 'A steel tray of rolled ham skewers with mint, pomegranate seeds and lemon zest',
      'g3.t': 'The tasting plate',
      'g3.p': 'Two small soups, a savoury tart and a tartare, on one plate.',
      'g3.l1': 'Tomato soup',
      'g3.l2': 'Savoury tart with cream and chive',
      'g3.l3': 'Sweetcorn soup with charred corn',
      'g3.l4': 'Beef tartare with pickle',
      ...
      'g.cta': 'Request a quote',
      'gallery.oven': 'From the oven',
    ...
    ro: {
      ...
      'gallery.title': 'Vezi cu ochii tăi',
      ...
      'gallery.lead': 'Câteva lucruri pe care le facem.',
      'g1.t': 'Masa comună',
      'g1.p': 'Roșii și ardei copți, hummus, măsline marinate și focaccia. Culoare, ulei de măsline și ierburi, făcute ca să fie împărțite.',
      'g1.l1': 'Roșii coapte, usturoi și rozmarin',
      'g1.l2': 'Măsline marinate, cu mentă și lămâie',
      'g1.l3': 'Hummus cu rodie și semințe de pin',
      'alt.g1': 'Vedere de sus: roșii coapte, măsline marinate și un bol de hummus cu rodie',
      'g2.t': 'Frigărui de șuncă rulată',
      'g2.p': 'Finger food, terminat cu mentă, rodie și coajă de lămâie.',
      'alt.g2': 'O tavă de inox cu frigărui de șuncă rulată, cu mentă, semințe de rodie și coajă de lămâie',
      'g3.t': 'Farfuria de degustare',
      'g3.p': 'Două supe mici, o tartă sărată și un tartar, într-o singură farfurie.',
      'g3.l1': 'Supă de roșii',
      'g3.l2': 'Tartă sărată cu cremă și arpagic',
      'g3.l3': 'Supă de porumb, cu porumb ars',
      'g3.l4': 'Tartar de vită cu murătură',
